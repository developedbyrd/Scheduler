        ...
        {navItems.map((item) => {
          ...
          return (
            <NavLink
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded text-sm transition-all duration-150 border ${isActive ? "bg-red-50 text-red-500 border-red-100" : "text-slate-500 hover:bg-slate-50 border-transparent hover:text-slate-700"}`}
            >
              {item.icon && (
                <item.icon
